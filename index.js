...
mongoose.connect("mongodb+srv://sample:sample@cluster0-lg31k.mongodb.net/test?retryWrites=true&w=majority", {useNewUrlParser: true});
    ...
    if (req.query.code) {
        ...
        //Prettify the JSON format using pre tag and JSON.stringify
            ...
            if (body.access_token) {
                ...
                request.get('https://api.zoom.us/v2/users/1997sprocks@gmail.com/meetings', function (error, response, body) {
                    if(error){
